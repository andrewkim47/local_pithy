...
# datas[key]['zband'][0].to_csv(fdir2+'QU_Zn_Region0_Norm.csv')
# datas[key]['zband'][1].to_csv(fdir2+'QU_Zn_Region1_Norm.csv')
# datas[key]['zband'][2].to_csv(fdir2+'QU_Zn_Region2_Norm.csv')
# datas[key]['zband'][3].to_csv(fdir2+'QU_Zn_Region3_Norm.csv')
# datas[key]['zband'][4].to_csv(fdir2+'QU_Zn_Region4_Norm.csv')
# datas[key]['Zband'][0].to_csv(fdir2+'QU_Zn_RegionAll_Norm.csv')
# datas[key]['Aband'][0].to_csv(fdir2+'QU_Zn_RegionAll_Raw.csv')
