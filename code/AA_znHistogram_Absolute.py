...
for kees in biglist:
    for key in kees:
        ...
        datas[key]['zband'][0].to_csv(fdir2+key+'_Zn_Region0_Norm.csv')
        datas[key]['zband'][1].to_csv(fdir2+key+'_Zn_Region1_Norm.csv')
        datas[key]['zband'][2].to_csv(fdir2+key+'_Zn_Region2_Norm.csv')
        datas[key]['zband'][3].to_csv(fdir2+key+'_Zn_Region3_Norm.csv')
        datas[key]['zband'][4].to_csv(fdir2+key+'_Zn_Region4_Norm.csv')
        
        datas[key]['Zband'][0].to_csv(fdir2+key+'_Zn_Region0_Abs.csv')
        datas[key]['Zband'][1].to_csv(fdir2+key+'_Zn_Region1_Abs.csv')
        datas[key]['Zband'][2].to_csv(fdir2+key+'_Zn_Region2_Abs.csv')
        datas[key]['Zband'][3].to_csv(fdir2+key+'_Zn_Region3_Abs.csv')
        datas[key]['Zband'][4].to_csv(fdir2+key+'_Zn_Region4_Abs.csv')
        
        
        datas[key]['aband'][0].to_csv(fdir2+key+'_Zn_RegionAll_Norm.csv')
        datas[key]['Aband'][0].to_csv(fdir2+key+'_Zn_RegionAll_Raw.csv')
