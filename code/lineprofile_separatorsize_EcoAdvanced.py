...
codes = [
'EA_B1_C_WT_TIFF', #thres=-45,min_dist=50,min_marg=0.15,up_marg=75
# 'EA_B1_D_WT_TIFF', #thres=-50,min_dist=50,min_marg=0.15,up_marg=75
# 'EA_C1_C_RT_TIFF', #thres=-50,min_dist=50,min_marg=0.15,up_marg=75
# 'EA_C1_D_RT_TIFF', #thres=-60,min_dist=50,min_marg=0.15,up_marg=75
# 'EA_C1R_C_CT_TIFF', #thres=-60,min_dist=50,min_marg=0.15,up_marg=75
# 'EA_C1R_D_CT_TIFF', #thres=-65,min_dist=50,min_marg=0.15,up_marg=75
]
thr = -45
mindist = 50
minmarg = 0.15
